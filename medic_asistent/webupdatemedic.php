...
.centered-form .panel {
            ...
            <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center">Actualizare Utilizator</h3>
                    </div>
                    <div class="panel-body">
                        <form  action="updatemedicas.php" method="post">
  ...
  <optgroup label="ROL:">
    ...
    <option name="medic" value="asistent">Asistent/a</option>
                            ...
                            <input type="submit"  name="submit" value="Trimite" class="btn btn-info btn-block">
                        </form>
                    </div>
                </div>
            </div>
