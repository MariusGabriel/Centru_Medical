(function() {
    ...
    Z.Ya && (Z.j = {
            ...
            if (Z.S(Z.global.Pb)) Z.B = Z.global.Pb;
            else if (Z.vb())
        ...
        Z.Lc = function(a, c, d) {
            ...
            try {
                ...
                var d;
                if (Z.Ab(a)) d = a.call(Z.global, {});
                else if (Z.h(a)) d = Z.Wc.call(Z.global, a);
    ...
    Z.c.tb = function(a) {
        if (!Z.c.Nb.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(Z.c.Ob, "&amp;")); - 1 != a.indexOf("<") && (a = a.replace(Z.c.ac, "&lt;")); - 1 != a.indexOf(">") && (a = a.replace(Z.c.Wb, "&gt;")); - 1 != a.indexOf('"') && (a = a.replace(Z.c.ec, "&quot;")); - 1 != a.indexOf("'") && (a = a.replace(Z.c.hc, "&#39;")); - 1 != a.indexOf("\x00") && (a = a.replace(Z.c.cc, "&#0;"));
